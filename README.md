...
## 🌟 關於我
- 20歲 `2003/10/15`，對**電子電路**及**程式設計**有興趣
- 正在努力成為一個專業的軟體工程師 💪
- `NKUST` 電機工程系學生 ⚡
...
C  |  C++  |  C#  |  Go  |  PHP  |  Lua  |  Dart
HTML  |  CSS  |  SCSS  |  Pug
```

### 🔧 框架與工具
```
前端開發: Vue  |  React  |  Flutter
後端開發: Node.js  |  Express  |  Flask  |  Django
資料庫: SQL  |  Redis
部署工具: Docker  |  Nginx  |  Ansible
版本控制: Git
作業系統: Linux
```
